...
export const return_trips: ReturnTrip_type[] = [
    ...
    { id: 2, transport_type_id: 0, transport_company_id: 2, start_point_city_id: 1, destination_city_id: 2, remaining_seats: 15, price: 177300, round_trip: false, departure_date: new Date(2023, 0, 4, 6, 23, 0), receive_date: new Date(2023, 1, 4, 11, 40, 0), return_date: new Date(2023, 1, 5, 12, 2, 34), return_receive_date: new Date(2023, 1, 4, 13, 21, 0), return_transport_company_id: 1, shopping_type: 'chartered', trip_des: [''] },
    ...
    { id: 9, transport_type_id: 2, transport_company_id: 7, start_point_city_id: 1, destination_city_id: 2, remaining_seats: 25, price: 10000, round_trip: false, departure_date: new Date(2023, 0, 1, 11, 23, 0), receive_date: new Date(2023, 1, 3, 11, 0, 0), return_date: new Date(2023, 1, 4, 12, 2, 34), return_receive_date: new Date(2023, 1, 3, 13, 21, 0), return_transport_company_id: 1, shopping_type: 'chartered', trip_des: [''] },
    { id: 10, transport_type_id: 2, transport_company_id: 8, start_point_city_id: 1, destination_city_id: 2, remaining_seats: 8, price: 1230, round_trip: false, departure_date: new Date(2023, 0, 2, 11, 23, 0), receive_date: new Date(2023, 1, 2, 11, 40, 0), return_date: new Date(2023, 1, 4, 12, 2, 34), return_receive_date: new Date(2023, 1, 4, 13, 21, 0), return_transport_company_id: 1, shopping_type: 'chartered', trip_des: [''] },
    ...
    { id: 12, transport_type_id: 2, transport_company_id: 7, start_point_city_id: 1, destination_city_id: 2, remaining_seats: 18, price: 17000, round_trip: false, departure_date: new Date(2023, 0, 4, 11, 23, 0), receive_date: new Date(2023, 1, 4, 19, 23, 0), return_date: new Date(2023, 1, 2, 12, 2, 34), return_receive_date: new Date(2023, 1, 5, 13, 21, 0), return_transport_company_id: 1, shopping_type: 'chartered', trip_des: [''] },
    { id: 13, transport_type_id: 2, transport_company_id: 8, start_point_city_id: 1, destination_city_id: 2, remaining_seats: 0, price: 18000, round_trip: false, departure_date: new Date(2023, 0, 2, 11, 23, 0), receive_date: new Date(2023, 1, 3, 19, 23, 0), return_date: new Date(2023, 1, 2, 12, 2, 34), return_receive_date: new Date(2023, 1, 4, 13, 21, 0), return_transport_company_id: 1, shopping_type: 'systematic', trip_des: [''] },
