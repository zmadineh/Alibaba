...
const Footer = (props: Props) => {
  ...
  return (
    <Grid container display={'flex'} direction={'column'}  justifyContent={'center'} alignItems={'center'} borderTop={1} borderColor={'divider'}>
            <Grid item container display={'flex'} direction={{xs:'column',md:'row'}} xs={12}maxWidth={'1200px'} width={{md:'1200px',xs:'auto'}} py={8}>
            ...
            <Grid item container xs={10} display={{xs:'none',md:'flex'}} justifyContent={'center'}pt={4} direction={{xs:'column',md:'row'}}borderTop={1} borderColor={'divider'}maxWidth={'1200px'}width={{md:'1200px',xs:'auto'}}py={8}>
            ...
            <Grid item container xs={10} display={'flex'} justifyContent={'center'}pt={4} flexDirection={{xs:'column-reverse',md:'row'}}borderTop={1} borderColor={'divider'}width={{md:'1200px',xs:'auto'}}py={8}>
