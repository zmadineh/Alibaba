...
const HelpCard = (): JSX.Element => {
    ...
    return (
        <Grid xs={12} container justifyContent={"center"} alignItems={"center"} marginBottom={3} >
            <Grid container item sx={{ border: 2, borderRadius: '10px 10px 10px 10px', borderColor: 'divider', bgcolor: 'common.white', maxWidth: "1000px" }} bgcolor={"common.white"} p={2} gap={2} justifyContent={"center"} alignItems={"center"}>
