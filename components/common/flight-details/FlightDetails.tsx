...
import FlightDetailsImage from '../../../public/Assets/Images/common/flight-details/FlightDetailsImage.png'
type Props = {}
  ...
  return (
    <Grid container bgcolor={'grey.900'}maxWidth={'1200px'} display={'flex'}justifyContent={'space-between'} flexDirection={'row-reverse'}pt={2}>
          ...
          <Grid item md={6}pt={2}xs={12}>
                <Typography fontWeight={'bold'} variant={'h6'}color={'grey.800'}>
                  {'بلیط هواپیما'}
                </Typography>
                <Typography py={4}fontSize={'16px'} variant={'body1'}color={'grey.600'}>
                ...
                <Typography pt={4}fontSize={'16px'} variant={'body1'}color={'grey.600'}>
          ...
          <Grid >
          <Typography fontSize={'16px'} pt={4} variant={'body1'}color={'grey.600'}>
...
برای پرداخت هزینه می‌توانید از کارت شتاب استفاده کنید. پس از پرداخت، خرید اینترنتی بلیط هواپیما با موفقیت انجام میشود و بلیط به ایمیل شما ارسال میشود. همچنین در همه این مراحل، پشتیبانی علی‌بابا در کنار شماست تا هر زمانی که سوال یا مشکلی داشتید، 24 ساعته پاسخگوی شما باشد.
          ...
          <Typography pt={4} sx={{textAlign:'start'}} fontWeight={'bold'} variant={'h6'}color={'grey.800'}>
